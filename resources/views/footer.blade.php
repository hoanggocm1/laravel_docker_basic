...
<div class="wrap-modal1 js-modal1 p-t-60 p-b-20">
    ...
    <div class="container">
        <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
            ...
            <div class="row">
                <div class="col-md-5 col-lg-6 p-b-30 flex flex">
                    <form action="/dangnhap" method="post">
                        <div class="p-30 p-t-5 p-lr-0-lg" style="border-radius: 10px; margin: 10px;     padding: 30px 30px 30px 30px;     border: 2px solid #333;">
                            <h4 class="mtext-105 cl2 js-name-detail p-b-14">
                                Login
                            </h4>
                            <div class="form-group p-t-15" style="margin-bottom: unset;">
                                <label>Email</label>
                                <input type="text" name="customer_email" class="form-control " placeholder="Email" required>
                            </div>
                            <div class="form-group p-t-15" style="margin-bottom: unset;">
                            ...
                            <div class="p-t-15" style="text-align: center;">
                                <div class="flex-w flex-m m-r-20 m-tb-5" style="display: inline-block;">
                                    <button class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 p-l-20  trans-04 pointer m-tb-5">
                                        Login
                                    </button>
                                </div>
                                @csrf
                    ...
                    <form action="/dangky" method="post">
                        <div class="p-30 p-t-5 p-lr-0-lg" style="border-radius: 10px; margin: 10px;     padding: 30px 30px 30px 30px;     border: 2px solid #333;">
                            ...
                            <div class="form-group p-t-15" style="margin-bottom: unset;">
                                ...
                                <input type="text" name="name" class="form-control " placeholder="Name customer" required>
                            </div>
                            <div class="form-group p-t-15" style="margin-bottom: unset;">
                                <label>Email</label>
                            ...
                            <div class="form-group p-t-15" style="margin-bottom: unset;">
                                <label>Password</label>
                                <input type="text" name="customer_password" class="form-control " placeholder="Password" required>

                            </div>
                            <div class="form-group p-t-15" style="margin-bottom: unset;">
                                <label>Password confirm</label>
                                <input type="text" name="customer_password_confirm" class="form-control " placeholder="Password confirm" required>
